...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2017 at 08:18 AM
...
INSERT INTO `news` (`id`, `title`, `summary`, `detail`, `image`, `author`, `update_at`, `create_at`, `views`) VALUES
...
INSERT INTO `users` (`id`, `username`, `password`, `fullname`, `birthdate`, `gender`, `address`, `email`, `identitycard`, `mobiphone`, `role`) VALUES
